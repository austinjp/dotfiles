...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (svelte-mode cython-mode which-key web-mode flycheck-yamllint flycheck-pycheckers flycheck-popup-tip flycheck-mypy flycheck-languagetool flycheck-checkbashisms flycheck magit psgml dockerfile-mode markdown-mode spinner ejc-sql simple-httpd skewer-mode quote
